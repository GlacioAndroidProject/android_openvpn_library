...
public class OboloiVPN extends Activity {
    ...
    public void launchVPN(String ovpnFileContent, String user,  String pass){
        OboloiVPN.ovpnFileContent = ovpnFileContent;
        OboloiVPN.profileIntent = VpnService.prepare(activity);
        OboloiVPN.user = user;
        OboloiVPN.pass = pass;
        if(OboloiVPN.profileIntent != null) {
    ...
    private void startVpn() {
        try {
            ...
            OpenVpnApi.startVpn(activity, ovpnFileContent, "South Africa", user, pass);
